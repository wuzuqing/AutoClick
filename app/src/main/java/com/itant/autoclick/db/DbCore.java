...
package com.itant.autoclick.db;
...
import com.itant.autoclick.dao.DaoMaster;
import com.itant.autoclick.dao.DaoSession;
import com.itant.autoclick.youtu.FileUtil;
...
public class DbCore {
    //默认数据库的名称
    private static final String DEFAULT_DB_NAME = "auto_click.db";
